...
📝 Prepare two sets of data: (1) one data set with values from different
categories, e.g. values in different conditions; (2) one data set with
one value to plot against the other, e.g. height and weight of
individuals.
...
The table should now appear under the *Environment* tab, and if you
click on it you will be able to inspect its content.
